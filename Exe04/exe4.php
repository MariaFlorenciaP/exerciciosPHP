<!DOCTYPE html>
	...
	<head>
		...
		<link rel="stylesheet" href="lolo4.css">
	</head>
	<body>
...
//criando vetor auxiliar 
	...
	if (empty($vetorTemp)) {
		echo"<p><span>Nenhuma das pessoas cadastradas no vetor tem menos de 18 anos. </span></p>";
							}
		...
		echo "<p><span> A pessoa mais velha é $pessoaMaior e a sua idade é $maisVelho.</span></p>";
